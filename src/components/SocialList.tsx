...
type RuleNames = "socials" | "icon";

interface SocialListProps {
  mini?: boolean;
}

const useStyles = createUseStyles<RuleNames, SocialListProps, CustomTheme>((theme) => ({
  socials: {
    display: "flex",
...
export const SocialList = (props: SocialListProps) => {
  ...
  return (
    <div className={classes.socials}>
      <SocialLink
        link="https://www.twitter.com/HelenAimeeArt/"
        title="X (Twitter)"
        mini={!!props.mini}
        noLeftPadding
      >
      ...
      <SocialLink
        link="https://bsky.app/profile/helenaimeeart.bsky.social"
        title="Bluesky"
        mini={!!props.mini}
      >
        <Bluesky />
      ...
      <SocialLink
        link="https://www.instagram.com/helenaimeeart/"
        title="Instagram"
        mini={!!props.mini}
      >
        <Instagram />
      ...
      <SocialLink
        link="https://www.deviantart.com/helenaimeeart"
        title="DeviantArt"
        mini={!!props.mini}
      >
        <DeviantArt />
      ...
      <SocialLink
        link="https://www.artstation.com/helen_aimee"
        title="ArtStation"
        mini={!!props.mini}
      >
        <ArtStation />
      ...
      <SocialLink
        link="https://www.youtube.com/channel/UCsJn3W5RUnKKQKwHiMbiFKA"
        title="YouTube"
        mini={!!props.mini}
      >
        <YouTube />
