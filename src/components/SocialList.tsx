...
const useStyles = createUseStyles<RuleNames, SocialListProps, CustomTheme>((props) => ({
  socials: {
    display: "flex",
...
export const SocialList = (props: SocialListProps) => {
  ...
  return (
    <div className={classes.socials}>
      ...
      {/* <SocialLink link="https://www.twitter.com/HelenAimeeArt/" title="X (Twitter)" mini={!!props.mini}>
                <X />
            </SocialLink> */}
