...
type RuleNames = "container" | "a" | "aMini";
...
const useStyles = createUseStyles<RuleNames, SocialLinkProps, CustomTheme>((theme) => ({
  container: (props) => ({
  ...
  return (
    <div className={classes.container} title={props.title}>
      <a
        ...
        className={props.mini ? classes.aMini : classes.a}
      >
